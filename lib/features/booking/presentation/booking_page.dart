            ...
            return Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8,),
                  DatePickerField(title: 'تاریخ اقامت', hint: 'بازه زمانی خود را مشخص کنید',
                  initialValue: bookingProvider.booking.checkInOutRangsDate,
                  validator: (value) {
                    if (value == null) {
                      return 'لطفا بازه ی زمانی را انتخاب کنید';
                    }
                    return null;
                  },
                  onSaved: (newValue) {
