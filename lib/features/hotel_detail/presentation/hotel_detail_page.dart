                      ...
                      Row(
                        ...
                        children: [
                          TextButton(onPressed: () {
                            PersistentNavBarNavigator.pushNewScreen(context, screen: FullScreenMapPage(latitude: hotel.location.latitude, longitude: hotel.location.longitude, hotelName: hotel.name),
                            withNavBar: false,
                            pageTransitionAnimation: PageTransitionAnimation.cupertino);
                          }, 
                          child: Text(
                          ...
                          child: FlutterMap(
                            ...
                            children: [
                              TileLayer(
                                ...
                                userAgentPackageName: 'ir.majid.hotelino',
                              ),
                              MarkerLayer(
                                markers: [
                                  Marker(
